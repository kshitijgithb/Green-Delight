  ...
  <div className="carousel-inner">
    <div className="carousel-item active">
      <img style={{"filter" : "brightness(80%)",
                "maxHeight":"500px","objectFit":"cover"}} src="https://source.unsplash.com/random/300×300?farming" className="d-block w-100" alt="..."/>
    ...
    <div className="carousel-item">
      <img style={{"filter" : "brightness(80%)",
                "maxHeight":"500px","objectFit":"cover"}} src="https://source.unsplash.com/random/300×300?organicfarming" className="d-block w-100" alt="..."/>
      <div className="carousel-caption d-none d-md-block">
